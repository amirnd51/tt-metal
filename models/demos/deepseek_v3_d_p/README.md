...
- **`PREFILL_MODEL`** — Which model adapter the runner / producers use (`deepseek_v3_d_p` | `deepseek_v32` | `glm_5_1` | `glm_5_2` | `kimi_k2_6` | `kimi_k2_7` | `minimax_m3` | `gpt_oss_d_p` | `mistral_small_4_119b`). Defaults to `kimi_k2_7`. Replaces the former `PREFILL_MODEL_VARIANT`.
