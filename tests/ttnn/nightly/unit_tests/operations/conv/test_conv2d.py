...
@pytest.mark.parametrize("device_params", [{"l1_small_size": 16384}], indirect=True)
def test_conv2d_math_approx_fused_activation_cache_miss_and_hit(device, torch_tensor_map):
    """The resolved math-approx flag must reach fused activation kernels on both cache paths."""
