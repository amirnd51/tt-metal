...
FORCE_INLINE void pool_2d_compute_impl(uint32_t runtime_num_out_sticks) {
    ...
    constexpr auto reduce_op = is_avg_pool_arg ? ckernel::PoolType::AVG : ckernel::PoolType::MAX;
    constexpr auto reduce_dim = ckernel::ReduceDim::REDUCE_COL;
    constexpr bool is_avg_pool = reduce_op == ckernel::PoolType::AVG;
