...
ttnn::device_operation::ProgramArtifacts ConvertToCHWProgramFactory::create_program_artifacts(
    ...
    const KernelSpec reader{
        ...
        .runtime_arg_schema = {.common_runtime_arg_names = {"total_tiles"}},
    ...
    reader_run.common_runtime_arg_values = {{"total_tiles", total_tiles_per_core}};
    compute_run.common_runtime_arg_values = {{"total_tiles", total_tiles_per_core}};
    writer_run.common_runtime_arg_values = {{"total_tiles", total_tiles_per_core}};
